...
<div id="hot" class="auto">
	...
	<ul class="newlist">
		<!-- 20条 -->
		<li><a href="#">[新闻]</a> <a href="#">招聘啦。。。。</a></li>
...
<div class="box auto">
	<div class="title">
		<a href="list_father_company.php?id=<?php echo $data_father['id']?>" style="color:#105cb6;"><?php echo $data_father['module_name']?></a>
	</div>
	<div class="classList">
		<?php 
			...
			while ($data_son=mysqli_fetch_assoc($result_son)){
				...
				$html=<<<A
					<div class="childBox new">
						<h2><a href="list_son_company.php?id={$data_son['id']}">{$data_son['module_name']}</a> <span>(今日{$count_today})</span></h2>
						帖子：{$count_all}<br />
					</div>
A;
				echo $html;
